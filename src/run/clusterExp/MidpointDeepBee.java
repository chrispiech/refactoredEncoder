...
public class MidpointDeepBee {
	private static final String LANGUAGE = "karel";
	private static final String MODEL_TYPE = "deepbee";
	private static final String NAME_BASE = "honeybee";
	...
	private void setParameters() {
		...
		int miniBatchSize = (int) getParamLogScale(1000, 100000);
	...
	public static void main(String[] args) {
		...
		new MidpointDeepBee().run(argName);
	}
}
